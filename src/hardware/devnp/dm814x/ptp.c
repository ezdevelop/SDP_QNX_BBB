...
{
    uint64_t ts = 0;
    int32_t loop = 1000; /* Normally first time through but just in case */
...
void ti814x_set_compensation (ti814x_dev_t *ti814x, ptp_comp_t comp)
{
    ...
    /* M = (1billion +- compensation) / 500000 */
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/io-pkt/sys/dev_qnx/dm814x/ptp.c $ $Rev: 716035 $")
#endif
