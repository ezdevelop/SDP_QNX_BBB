...
//	outle32 (ti814x->cpsw_regs + MDIOCONTROL, MDIO_ENABLE | MDIO_FAULT | MDIO_FAULTENB | 0x63);
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/lib/io-pkt/sys/dev_qnx/dm814x/mii.c $ $Rev: 718701 $")
#endif
