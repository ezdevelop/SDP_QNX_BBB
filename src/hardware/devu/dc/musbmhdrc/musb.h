...
#define USE_DMA(ep)		( ( ep->dma_chidx >= 0 ) ? 1 : 0 )
...
typedef enum { DMA_MODE0, DMA_MODE1 } dmamode_t;
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/devu/dc/musbmhdrc/musb.h $ $Rev: 725146 $")
#endif
