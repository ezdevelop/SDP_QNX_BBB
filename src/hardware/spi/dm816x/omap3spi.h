...
#define OMAP3_MCSPI_CTRL_EXTCLK				(0xFF<<8)
...
extern int omap3_cfg(void *hdl, spi_cfg_t *cfg);
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/hardware/spi/dm816x/omap3spi.h $ $Rev: 716134 $")
#endif
