...
#define NET_CLOCK_IDX 	0
	...
	{ "mgt5200",    	init_mgt5200, get_mgt5200, set_mgt5200},
   	...
   	{ "ds1337",     	init_ds1337, get_ds1337, set_ds1337 },
#endif
#ifdef	__SH4__
	...
	{ "s3c2400",    	init_s3c2400, get_s3c2400, set_s3c2400 },
    	...
    	{ "dm816x",		init_dm816x, get_dm816x, set_dm816x },
    	{ "phoenix",		init_phoenix, get_phoenix, set_phoenix },
    	{ "rocket",             init_rocket, get_rocket, set_rocket },
	{ "triton",     	init_triton, get_triton, set_triton },
	{ "tuareg",		init_tuareg, get_tuareg, set_tuareg },
	{ "mc9328mxlads",	init_mc9328mxlads, get_mc9328mxlads, set_mc9328mxlads },
	{ "mx25srtc",		init_mx25srtc, get_mx25srtc, set_mx25srtc },
	{ "mx6srtc",		init_mx6srtc, get_mx6srtc, set_mx6srtc},
#endif
	{ NULL,			NULL }
};
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/utils/r/rtc/qnxrtc.c $ $Rev: 725908 $")
#endif
