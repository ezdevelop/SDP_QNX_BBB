...
extern int init_dm816x(struct chip_loc *chip, char *argv[]);
extern int get_dm816x(struct tm *tm, int cent_reg);
extern int set_dm816x(struct tm *tm, int cent_reg);

extern int init_phoenix(struct chip_loc *chip, char *argv[]);
extern int get_phoenix(struct tm *tm, int cent_reg);
extern int set_phoenix(struct tm *tm, int cent_reg);

extern int init_rocket(struct chip_loc *chip, char *argv[]);
extern int get_rocket(struct tm *tm, int cent_reg);
extern int set_rocket(struct tm *tm, int cent_reg);
...
extern int init_mx25srtc(struct chip_loc *chip, char *argv[]);
extern int get_mx25srtc(struct tm *tm, int cent_reg);
extern int set_mx25srtc(struct tm *tm, int cent_reg);

extern int init_mx6srtc(struct chip_loc *chip, char *argv[]);
extern int get_mx6srtc(struct tm *tm, int cent_reg);
extern int set_mx6srtc(struct tm *tm, int cent_reg);
#endif
...
__SRCVERSION("$URL: http://svn/product/branches/6.6.0/trunk/utils/r/rtc/rtc.h $ $Rev: 725908 $")
#endif
